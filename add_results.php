...
<body>
    ...
    <div class="main">
        <form class="form-margine" action="" method="post">
            ...
            <legend>Enter Marks</legend>
                ...
                <input type="text" name="p1" id="" placeholder="Bangla">
                <input type="text" name="p2" id="" placeholder="English">
                <input type="text" name="p3" id="" placeholder="Mathemetics">
                <input type="text" name="p4" id="" placeholder="Religion">
                <input type="text" name="p5" id="" placeholder="History">
